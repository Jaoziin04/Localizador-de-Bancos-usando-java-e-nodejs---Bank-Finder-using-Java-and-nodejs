...
public class ClienteWS
{
    ...
    public static Object pegarTodos(Class tipoObjetoRetorno,
                                       String urlWebService)
    {
        Object objetoRetorno = null;
        ...
        try
        {
            ...
            */
            ...
            HttpURLConnection connection =
                    (HttpURLConnection) url.openConnection();
            byte[] JsonStringEncoder= new byte[600];

            /*Collection<Banco> readValues = new ObjectMapper().readValue(
//                    JsonStringEncoder, new TypeReference<Collection<Banco>>() { }
*/
            connection.setRequestMethod("GET");
            connection.setConnectTimeout(15000);
            //connection.setRequestProperty("login", "seulogin");
        ...
        {
            erro.printStackTrace();
            System.out.println("Não há bancos aqui");
        }
